...
export const ParticleCount = (id: string, c: number) =>
  ({
    '10000038': [{ name: 'Transient Blossom', default: 1, value: 0, variance: 0.5, pps: 0.3, duration: 30 }],
    '10000078': [
      { name: 'Projection Attack', default: 0, value: 1, variance: 0 },
      { name: 'Full Uptime', default: 1, value: 7, variance: 0 },
    ],
    ...
    '10000094': [{ name: 'Tamoto', default: 1, value: 0, variance: 0.2, pps: 0.33, duration: 17 }],
    ...
    '10000079': [{ name: 'Fiery Sanctum', default: 1, value: 0, variance: 0.5, pps: 0.33, duration: 12 }],
    '10000016': [
    ...
    '10000031': [{ name: 'Oz', default: 1, value: 0, variance: 0.5, pps: 2 / 3, duration: c >= 6 ? 12 : 10 }],
    '10000085': [
    ...
    '10000089': [{ name: 'Salon Solitaire', default: 1, value: 0, variance: 0.5, pps: 0.3, duration: 30 }],
    ...
    '10000065': [
      { name: 'Skill Ring', default: 1, value: 1, variance: 0, pps: c >= 4 ? 0.39 : 0.3, duration: c >= 2 ? 15 : 12 },
    ],
    '10000074': [
    ...
    '10000073': [{ name: 'TKP', default: 1, value: 0, variance: 0, pps: 0.36, duration: 25 }],
    ...
    '10000052': [{ name: 'Coordinated Attack', default: 1, value: 0, variance: 0.5, pps: 0.45, duration: 25 }],
    '10000020': [
      { name: 'Skill Press', default: 1, value: 3, variance: 0 },
      { name: 'Skill Hold', default: 0, value: 4, variance: 0 },
    ],
    '10000045': [{ name: 'Skill Cast', default: 1, value: 3, variance: 0 }],
    '10000054': [{ name: 'Kurage', default: 1, value: 0, variance: 0.5, pps: 1 / 3, duration: 12 }],
    ...
    '10000023': [{ name: 'Guoba', default: 1, value: 0, variance: 0, pps: 0.5, duration: 7 }],
    ...
    '10000058': [{ name: 'Sesshou Sakura', default: 1, value: 0, variance: 0, pps: 5 / 14, duration: 14 }],
    '10000048': [{ name: 'Skill Cast', default: 1, value: 3, variance: 0 }],
    '10000077': [{ name: 'Yuegui', default: 1, value: 0, variance: 0, pps: 0.5, duration: 10 }],
    ...
    '10000099': [
      { name: 'Lumidouce Case', default: 1, value: 0, variance: 0, pps: 7 / 22, duration: 22 },
      { name: 'Burst Cast', default: 1, value: -1, variance: 0 },
    ],
    '10000100': [
      { name: 'Skill Hit', default: 0, value: 2 / 3, variance: 2 / 3 },
      { name: 'Unmount Full Uptime', default: 1, value: 0, variance: 0.5, pps: 1 / 3, duration: 12 },
      { name: 'Mount Full Uptime', default: 0, value: 4, variance: 0.5 },
    ],
    '10000102': [{ name: `Sharky's Bite`, default: 1, value: 4.5, variance: 1 / 9 }],
    '10000101': [{ name: `Scalespiker Cannon`, default: 1, value: 5, variance: 0 }],
    '10000103': [{ name: `Skill Cast`, default: 1, value: 4, variance: 0 }],
    '10000104': [{ name: `Shadowhunt Shell`, default: 1, value: 5, variance: 0 }],

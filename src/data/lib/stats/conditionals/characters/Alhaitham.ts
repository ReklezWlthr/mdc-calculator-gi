...
const Alhaitham = (c: number, a: number, t: ITalentLevel, stat: StatObjectT) => {
  const upgrade = {
    normal: false,
    skill: c >= 3,
    burst: c >= 5,
  ...
  const a4Em = _.min([stat.em * 0.001, 1])
  ...
  const talents: ITalent = {
    ...
    skill: {
      ...
      <br />When this skill is unleashed, Alhaitham will generate <span class="text-yellow">1</span> Chisel-Light Mirror. If there are no Mirrors at this time, he will generate <span class="text-yellow">1</span> additional Mirror. Chisel-Light Mirrors will have the following properties:
      ...
      <br />- A total of <span class="text-yellow">3</span> Chisel-Light Mirrors can exist at once.
    ...
    burst: {
      ...
      <br /><span class="text-yellow">2</span>s after this ability is unleashed, if <span class="text-yellow">0/1/2/3</span> Mirrors were consumed, Alhaitham will generate <span class="text-yellow">3/2/1/0</span> new Mirrors in turn.`,
    },
    a1: {
      title: `A1: Four-Causal Correction`,
      content: `When Alhaitham's Charged or Plunging Attacks hit opponents, they will generate <span class="text-yellow">1/3</span> Chisel-Light Mirror. This effect can be triggered once every <span class="text-yellow">12</span>s.`,
    },
    a4: {
    ...
    c1: {
      title: `C1: Intuition`,
      content: `When a Projection Attack hits an opponent, Universality: An Elaboration on Form's CD is decreased by <span class="text-yellow">1.2</span>s. This effect can be triggered once every <span class="text-yellow">1</span>s.`,
    },
    c2: {
      title: `C2: Debate`,
      content: `When Alhaitham generates a Chisel-Light Mirror, his Elemental Mastery will be increased by <span class="text-yellow">50</span> for <span class="text-yellow">8</span> seconds, max <span class="text-yellow">4</span> stacks. Each stack's duration is counted independently. This effect can be triggered even when the maximum number of Chisel-Light Mirrors has been reached.`,
    },
    c3: {
      title: `C3: Negation`,
    ...
    c4: {
      ...
      <br />- Each Mirror consumed will increase the Elemental Mastery of all other nearby party members by <span class="text-yellow">30</span> for <span class="text-yellow">15</span>s.
      <br />- Each Mirror generated will grant Alhaitham a <span class="text-yellow">10%</span> <b class="text-genshin-dendro">Dendro DMG Bonus</b> for <span class="text-yellow">15</span>s.
      <br />
    ...
    c6: {
      ...
      <br />- <span class="text-yellow">2</span> seconds after Particular Field: Fetters of Phenomena is unleashed, he will generate <span class="text-yellow">3</span> Chisel-Light Mirrors regardless of the number of mirrors consumed.
      <br />- If Alhaitham generates Chisel-Light Mirrors when their numbers have already maxed out, his CRIT Rate and CRIT DMG will increase by <span class="text-yellow">10%</span> and <span class="text-yellow">70%</span> respectively for <span class="text-yellow">6</span>s. If this effect is triggered again during its initial duration, the duration remaining will be increased by 6s.
      `,
    },
  }

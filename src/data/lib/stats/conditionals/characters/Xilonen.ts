...
const Xilonen = (c: number, a: number, t: ITalentLevel, team: ITeamChar[]) => {
  ...
  const talents: ITalent = {
    ...
    skill: {
      ...
      <br />
      <br /><b>Nightsoul's Blessing: Xilonen</b>

...
const Navia = (c: number, a: number, t: ITalentLevel, team: ITeamChar[]) => {
  ...
  const talents: ITalent = {
    ...
    skill: {
      ...
      <br />When <span class="text-yellow">0/1/2/3</span> or more stacks of Crystal Shrapnel are consumed, <span class="text-yellow">5/7/9/11</span> Rosula Shardshots will be fired respectively. The more Rosula Shardshots that strike a single opponent, the greater the DMG dealt to them. When all <span class="text-yellow">11</span> Rosula Shardshots strike, <span class="text-yellow">200%</span> of the original amount of DMG is dealt.
      <br />In addition, when more than <span class="text-yellow">3</span> stacks of Crystal Shrapnel are consumed, every stack consumed beyond those <span class="text-yellow">3</span> will increase the DMG dealt by this Gunbrella attack by an additional <span class="text-yellow">15%</span>.
      <br />
      <br /><b>Hold</b>
    ...
    burst: {
      ...
      <br />When cannon attacks hit opponents, Navia will gain <span class="text-yellow">1</span> stack of Crystal Shrapnel. This effect can be triggered up to once every <span class="text-yellow">2.4</span>s.`,
    },
    a1: {
      title: `A1: Undisclosed Distribution Channels`,
      content: `For 4s after using Ceremonial Crystalshot, the DMG dealt by Navia's Normal Attacks, Charged Attacks, and Plunging Attacks will be converted into <b class="text-genshin-geo">Geo DMG</b> which cannot be overridden by other Elemental infusions, and the DMG dealt by Navia's Normal Attacks, Charged Attacks, and Plunging Attacks will be increased by <span class="text-yellow">40%</span>.`,
    },
    a4: {
      title: `A4: Mutual Assistance Network`,
      content: `For each <b class="text-genshin-pyro">Pyro</b>/<b class="text-genshin-electro">Electro</b>/<b class="text-genshin-cryo">Cryo</b>/<b class="text-genshin-hydro">Hydro</b> party member, Navia gains <span class="text-yellow">20%</span> increased ATK. This effect can stack up to <span class="text-yellow">2</span> times.`,
    },
    c1: {
      title: `C1: A Lady's Rules for Keeping a Courteous Distance`,
      content: `Each stack of Crystal Shrapnel consumed when Navia uses Ceremonial Crystalshot will restore <span class="text-yellow">3</span> Energy to her and decrease the CD of As the Sunlit Sky's Singing Salute by <span class="text-yellow">1</span>s. Up to <span class="text-yellow">9</span> Energy can be gained this way, and the CD of "As the Sunlit Sky's Singing Salute" can be decreased by up to <span class="text-yellow">3</span>s.`,
    },
    c2: {
      title: `C2: The President's Pursuit of Victory`,
      content: `Each stack of Crystal Shrapnel consumed will increase the CRIT Rate of this Ceremonial Crystalshot instance by <span class="text-yellow">12%</span>. CRIT Rate can be increased by up to <span class="text-yellow">36%</span> in this way.
    ...
    c3: {
      ...
      content: `Increases the Level of Ceremonial Crystalshot by <span class="text-yellow">3</span>.
      <br />Maximum upgrade level is <span class="text-yellow">15</span>.`,
    },
    c4: {
      title: `C4: The Oathsworn Never Capitulate`,
      content: `When As the Sunlit Sky's Singing Salute hits an opponent, that opponent's <b class="text-genshin-geo">Geo RES</b> will be decreased by <span class="text-yellow">20%</span> for <span class="text-yellow">8</span>s.`,
    },
    c5: {
      title: `C5: Negotiator's Resolute Negotiations`,
      content: `Increases the Level of As the Sunlit Sky's Singing Salute by <span class="text-yellow">3</span>.
      <br />Maximum upgrade level is <span class="text-yellow">15</span>.`,
    },
    c6: {
      title: `C6: The Flexible Finesse of the Spina's President`,
      content: `If more than <span class="text-yellow">3</span> stacks of Crystal Shrapnel are consumed when using Ceremonial Crystalshot, each stack consumed beyond the first <span class="text-yellow">3</span> increases the CRIT DMG of that Ceremonial Crystalshot by <span class="text-yellow">45%</span>, and any stacks consumed beyond the first <span class="text-yellow">3</span> are returned to Navia.`,
    },
  }

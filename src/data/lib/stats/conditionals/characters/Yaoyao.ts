...
const Yaoyao = (c: number, a: number, stat: StatObjectT) => {
  ...
  const talents: ITalent = {
    ...
    skill: {
      ...
      <br />- If nearby characters have <span class="text-yellow">70%</span> or less HP remaining, it will throw a radish at the character with the lowest HP percentage remaining. If no opponents exist nearby, Yuegui will throw White Jade Radishes at characters even if they all have more than <span class="text-yellow">70%</span> HP remaining.
      <br />
      <br />A maximum of <span class="text-yellow">2</span> instances Yuegui: Throwing Mode can exist at any one time.`,
    },
    burst: {
      ...
      <br />- Summons "Yuegui: Jumping Mode" at intervals until their limit has been reached. The behavior of this version of Yuegui is the same as that of "Yuegui: Throwing Mode" in the Elemental Skill, Raphanus Sky Cluster. A maximum of <span class="text-yellow">3</span> Yuegui: Jumping Mode can exist at any one time.
      <br />- Yaoyao's Movement SPD is increased by <span class="text-yellow">15%</span>.
    ...
    c2: {
      title: `C2: Innocent`,
      content: `While affected by the Adeptal Legacy state caused by Moonjade Descent, if White Jade Radish explosions damage opponents, <span class="text-yellow">3</span> Energy will be restored to Yaoyao. This form of Energy regeneration can occur once every <span class="text-yellow">0.8</span>s.`,
    },
    c3: {
    ...
    c6: {
      title: `C6: Beneficent`,
      content: `For every <span class="text-yellow">2</span> White Jade Radishes Yuegui: Throwing Mode throws out, it will also throw a Mega Radish that will have a larger AoE than the standard White Jade Radish and have the following effects upon exploding:
      <br />Deals <b class="text-genshin-dendro">AoE Dendro DMG</b> based on <span class="text-yellow">75%</span> of Yaoyao's ATK.
      <br />Restores HP for the active character based on <span class="text-yellow">7.5%</span> of Yaoyao's Max HP.
      <br />
      <br />Every Yuegui: Throwing Mode can throw out a maximum of <span class="text-yellow">2</span> Mega Radishes.`,
    },
  }
  ...
  return {
    ...
    preCompute: (form: Record<string, any>) => {
      ...
      base.SKILL_SCALING = [
        {
          ...
          value: [{ scaling: calcScaling(0.2992, 10, 'elemental', '1'), multiplier: Stats.ATK }],
          element: Element.DENDRO,
          property: TalentProperty.SKILL,
        },
        {
          name: 'White Jade Radish Healing',
          value: [{ scaling: calcScaling(0.0171, 10, 'elemental', '1'), multiplier: Stats.HP }],
      ...
      base.BURST_SCALING = [
        {
          name: 'Skill DMG',
          value: [{ scaling: calcScaling(1.1456, 10, 'elemental', '1'), multiplier: Stats.ATK }],
          element: Element.DENDRO,
          property: TalentProperty.BURST,
        },
        {
          name: 'Adeptal Legacy White Jade Radish DMG',
          value: [{ scaling: calcScaling(0.7216, 10, 'elemental', '1'), multiplier: Stats.ATK }],
          element: Element.DENDRO,
          property: TalentProperty.BURST,
        },
        {
          name: 'Adeptal Legacy White Jade Radish Healing',
          value: [{ scaling: calcScaling(0.0202, 10, 'elemental', '1'), multiplier: Stats.HP }],

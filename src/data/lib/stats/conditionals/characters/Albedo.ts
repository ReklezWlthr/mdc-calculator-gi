...
const Albedo = (c: number, a: number, t: ITalentLevel) => {
  ...
  const talents: ITalent = {
    ...
    burst: {
      ...
      <br />If a Solar Isotoma created by Albedo himself is on the field, <span class="text-yellow">7</span> Fatal Blossoms will be generated in the Solar Isotoma field, bursting violently into bloom and dealing <b class="text-genshin-geo">AoE Geo DMG</b>.
      <br />
    ...
    util: {
      ...
      content: `When Albedo crafts Weapon Ascension Materials, he has a <span class="text-yellow">10%</span> chance to receive double the product.`,
    },
    c1: {
      title: 'A1: Calcite Might',
      content: `Transient Blossoms generated by Abiogenesis: Solar Isotoma deal <span class="text-yellow">25%</span> more DMG to opponents whose HP is below <span class="text-yellow">50%</span>.`,
    ...
    c3: {
      title: 'C3: Calcite Might',
      content: `Increases the Level of Abiogenesis: Solar Isotoma by <span class="text-yellow">3</span>.
    ...
    c5: {
      title: 'C5: Calcite Might',
      content: `Increases the Level of Rite of Progeniture: Tectonic Tide by <span class="text-yellow">3</span>.
      <br />Maximum upgrade level is <span class="text-yellow">15</span>.`,
    },
    c6: {

...
const Gaming = (c: number, a: number, t: ITalentLevel, stat: StatObjectT) => {
  const upgrade = {
    normal: false,
    skill: c >= 3,
    burst: c >= 5,
  ...
  const talents: ITalent = {
    ...
    skill: {
      ...
      <br />The DMG from Plunging Attacks caused by Bestial Ascent is converted to <b class="text-genshin-pyro">Pyro DMG</b> that cannot be overridden by other elemental infusions. Upon landing, Gaming will consume a fixed amount of HP. Gaming's HP cannot be reduced below <span class="text-yellow">10%</span> by this method.
    ...
    burst: {
      ...
      <br />While Wushou Stance is active, his resistance to interruption is increased, and when Gaming lands with Charmed Cloudstrider attack or completes the forward pounce attack from Bestial Ascent with over <span class="text-yellow">50%</span> HP, he will summon Man Chai again.
    ...
    a1: {
      ...
      content: `After Bestial Ascent's Plunging Attack: Charmed Cloudstrider hits an opponent, Gaming will regain <span class="text-yellow">1.5%</span> of his Max HP once every <span class="text-yellow">0.2</span>s for <span class="text-yellow">0.8</span>s.`,
    },
    a4: {
      title: `A4: Air of Prosperity`,
      content: `When Gaming has less than <span class="text-yellow">50%</span> HP, he will receive a <span class="text-yellow">20%</span> Incoming Healing Bonus. When Gaming has <span class="text-yellow">50%</span> HP or more, Plunging Attack: Charmed Cloudstrider will deal <span class="text-yellow">20%</span> more DMG.`,
    },
    c1: {
      title: `C1: Bringer of Blessing`,
      content: `When the Suanni Man Chai from Suanni's Gilded Dance meets back up with Gaming, it will heal <span class="text-yellow">15%</span> of Gaming's HP.`,
    },
    c2: {
      title: `C2: Plum Blossoms Underfoot`,
      content: `When Gaming receives healing and this instance of healing overflows, his ATK will be increased by <span class="text-yellow">20%</span> for <span class="text-yellow">5</span>s.`,
    },
    c3: {
      title: `C3: Awakening Spirit`,
      content: `Increases the Level of Bestial Ascent by <span class="text-yellow">3</span>.
      <br />Maximum upgrade level is <span class="text-yellow">15</span>.`,
    },
    c4: {
      title: `C4: Soar Across Mountains`,
      content: `When Bestial Ascent's Plunging Attack: Charmed Cloudstrider hits an opponent, it will restore <span class="text-yellow">2</span> Energy to Gaming. This effect can be triggered once every <span class="text-yellow">0.2</span>s.`,
    },
    c5: {
      title: `C5: Evil-Daunting Roar`,
      content: `Increases the Level of Suanni's Gilded Dance by <span class="text-yellow">3</span>.
      <br />Maximum upgrade level is <span class="text-yellow">15</span>.`,
    },
    c6: {
      title: `C6: To Tame All Beasts`,
      content: `Bestial Ascent's Plunging Attack: Charmed Cloudstrider CRIT Rate increased by <span class="text-yellow">20%</span> and CRIT DMG increased by <span class="text-yellow">40%</span>, and its attack radius will be increased.`,
    },
  }

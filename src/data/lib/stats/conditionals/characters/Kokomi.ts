...
const Kokomi = (c: number, a: number, t: ITalentLevel) => {
  ...
  const talents: ITalent = {
    ...
    a4: {
      ...
      content: `While donning the Ceremonial Garment created by Nereid's Ascension, the Normal and Charged Attack DMG Bonus Sangonomiya Kokomi gains based on her Max HP will receive a further increase based on <span class="text-yellow">15%</span> of her Healing Bonus.`,
      value: [
        {
    ...
    c1: {
      ...
      content: `While donning the Ceremonial Garment created by Nereid's Ascension, the final Normal Attack in Sangonomiya Kokomi's combo will unleash a swimming fish to deal <span class="text-yellow">30%</span> of her Max HP as <b class="text-genshin-hydro">Hydro DMG</b>.
    ...
    c2: {
      ...
      <br />- Kurage's Oath Bake-Kurage: <span class="text-yellow">4.5%</span> of Kokomi's Max HP.
      <br />- Nereid's Ascension Normal and Charged Attacks: <span class="text-yellow">0.6%</span> of Kokomi's Max HP.`,
    },
    c3: {
      title: `C3: The Moon, A Ship O'er the Seas`,
      content: `Increases the Level of Nereid's Ascension by <span class="text-yellow">3</span>.
      <br />Maximum upgrade level is <span class="text-yellow">15</span>.`,
    },
    c4: {
      title: `C4: The Moon Overlooks the Waters`,
      content: `While donning the Ceremonial Garment created by Nereid's Ascension, Sangonomiya Kokomi's Normal Attack SPD is increased by <span class="text-yellow">10%</span>, and Normal Attacks that hit opponents will restore <span class="text-yellow">0.8</span> Energy for her.
      <br />This effect can occur once every <span class="text-yellow">0.2</span>s.`,
    },
    c5: {
      title: `C5: All Streams Flow to the Sea`,
      content: `Increases the Level of Kurage's Oath by <span class="text-yellow">3</span>.
      <br />Maximum upgrade level is <span class="text-yellow">15</span>.`,
    },
    c6: {
      title: `C6: Sango Isshin`,
      content: `While donning the Ceremonial Garment created by Nereid's Ascension, Sangonomiya Kokomi gains a <span class="text-yellow">40%</span> <b class="text-genshin-hydro">Hydro DMG Bonus</b> for <span class="text-yellow">4</span>s when her Normal and Charged Attacks heal, or would heal, any party member with <span class="text-yellow">80%</span> or more HP.`,
    },
  }

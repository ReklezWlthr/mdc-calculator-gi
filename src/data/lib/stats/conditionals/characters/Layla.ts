...
const Layla = (c: number, a: number, t: ITalentLevel) => {
  ...
  const talents: ITalent = {
    ...
    skill: {
      ...
      <br />While the Curtain of Slumber is active, it will create <span class="text-yellow">1</span> Night Star that will be attached to it every <span class="text-yellow">1.5</span>s. When a character protected by this shield uses an Elemental Skill, <span class="text-yellow">2</span> Night Stars will be created. Night Stars can be created once every <span class="text-yellow">0.3</span>s in this way. A maximum of <span class="text-yellow">4</span> Night Stars can be accumulated at any one time.
      <br />Once the Curtain of Slumber has accumulated <span class="text-yellow">4</span> Night Stars and there are opponents nearby, these Night Stars will transform into homing Shooting Stars that will be fired off in sequence, dealing <b class="text-genshin-cryo">Cryo DMG</b> to any opponents hit.
    ...
    burst: {
      ...
      <br />When a Starlight Slug hits, it will generate <span class="text-yellow">1</span> Night Star for nearby Curtains of Slumber. Each Curtain of Slumber can gain <span class="text-yellow">1</span> Night Star this way every <span class="text-yellow">0.5</span>s.`,
    },
    a1: {
      title: `A1: Like Nascent Light`,
      content: `While the Curtain of Slumber is active, the Deep Sleep effect will activate each time the Curtain gains <span class="text-yellow">1</span> Night Star:
      <br />- The Shield Strength of a character under the effect of the Curtain of Slumber increases by <span class="text-yellow">6%</span>.
      <br />- This effect can have a maximum of <span class="text-yellow">4</span> stacks and persists until the Curtain of Slumber disappears.`,
    },
    a4: {
      title: `A4: Sweet Slumber Undisturbed`,
      content: `The DMG dealt by the Shooting Stars fired by Nights of Formal Focus is increased by <span class="text-yellow">1.5%</span> of Layla's Max HP.`,
    },
    c1: {
      title: `C1: Fortress of Fantasy`,
      content: `The Shield Absorption of the Curtain of Slumber generated by Nights of Formal Focus is increased by <span class="text-yellow">20%</span>.
      <br />Additionally, when unleashing Nights of Formal Focus, she will generate a shield for any nearby party members who are not being protected by a Curtain of Slumber. This shield will have <span class="text-yellow">35%</span> of the absorption of a Curtain of Slumber, will last for <span class="text-yellow">12</span>s, and will absorb <b class="text-genshin-cryo">Cryo DMG</b> with <span class="text-yellow">250%</span> effectiveness.`,
    },
    c2: {
      title: `C2: Light's Remit`,
      content: `When Shooting Stars from Nights of Formal Focus strike opponents, they will each restore <span class="text-yellow">1</span> Energy to Layla. Each Shooting Star can restore Energy to her in this manner once.`,
    },
    c3: {
      title: `C3: Secrets of the Night`,
      content: `Increases the Level of Nights of Formal Focus by <span class="text-yellow">3</span>.
      <br />Maximum upgrade level is <span class="text-yellow">15</span>.`,
    },
    c4: {
      title: `C4: Starry Illumination`,
      content: `When Nights of Formal Focus starts to fire off Shooting Stars, it will grant all nearby party members the Dawn Star effect, causing their Normal and Charged Attack DMG to increase based on <span class="text-yellow">5%</span> of Layla's Max HP.
      <br />Dawn Star can last up to <span class="text-yellow">3</span>s and will be removed <span class="text-yellow">0.05</span>s after dealing Normal or Charged Attack DMG.`,
    },
    c5: {
      title: `C5: Stream of Consciousness`,
      content: `Increases the Level of Dream of the Star-Stream Shaker by <span class="text-yellow">3</span>.
      <br />Maximum upgrade level is <span class="text-yellow">15</span>.`,
    },
    c6: {
      title: `C6: Radiant Soulfire`,
      content: `Shooting Stars from Nights of Formal Focus deal <span class="text-yellow">40%</span> increased DMG, and Starlight Slugs from Dream of the Star-Stream Shaker deal <span class="text-yellow">40%</span> increased DMG.
      <br />Additionally, the interval between the creation of Night Stars via Nights of Formal Focus is decreased by <span class="text-yellow">20%</span>.`,
    },
  }

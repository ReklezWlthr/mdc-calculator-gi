...
const Cyno = (c: number, a: number, t: ITalentLevel, stat: StatObjectT) => {
  const upgrade = {
    normal: false,
    skill: c >= 5,
    burst: c >= 3,
  ...
  const talents: ITalent = {
    ...
    burst: {
      ...
      <br />
      <br />This effect will be canceled when Cyno leaves the field and lasts a maximum of <span class="text-yellow">18</span>s.`,
    },
    a1: {
      title: `A1: Featherfall Judgment`,
      content: `When Cyno is in the Pactsworn Pathclearer state activated by Sacred Rite: Wolf's Swiftness, Cyno will enter the Endseer stance at intervals. If he activates Secret Rite: Chasmic Soulfarer while affected by this stance, he will activate the Judication effect, increasing the DMG of this Secret Rite: Chasmic Soulfarer by <span class="text-yellow">35%</span>, and firing off 3 Duststalker Bolts that deal <span class="text-yellow">100%</span> of Cyno's ATK as <b class="text-genshin-electro">Electro DMG</b>.
    ...
    a4: {
      ...
      <br />Pactsworn Pathclearer's Normal Attack DMG is increased by <span class="text-yellow">150%</span> of his Elemental Mastery.
      <br />Duststalker Bolt DMG from his Passive Talent Featherfall Judgment is increased by <span class="text-yellow">250%</span> of his Elemental Mastery.`,
    },
    c1: {
      title: `C1: Ordinance: Unceasing Vigil`,
      content: `After using Sacred Rite: Wolf's Swiftness, Cyno's Normal Attack SPD will be increased by <span class="text-yellow">20%</span> for <span class="text-yellow">10</span>s. If the Judication effect of his Passive Talent Featherfall Judgment is triggered during Secret Rite: Chasmic Soulfarer, the duration of this increase will be refreshed.
      <br />You need to unlock the Passive Talent "Featherfall Judgement."`,
    },
    c2: {
      title: `C2: Ceremony: Homecoming of Spirits`,
      content: `When Cyno's Normal Attacks hit opponents, his <b class="text-genshin-electro">Electro DMG Bonus</b> will increase by <span class="text-yellow">10%</span> for <span class="text-yellow">4</span>s. This effect can be triggered once every <span class="text-yellow">0.1</span>s. Max <span class="text-yellow">5</span> stacks.`,
    },
    c3: {
    ...
    c6: {
      ...
      content: `After using Sacred Rite: Wolf's Swiftness or triggering the Judication effect of the Passive Talent "Featherfall Judgment," Cyno will gain <span class="text-yellow">4</span> stacks of the "Day of the Jackal" effect. When he hits opponents with Normal Attacks, he will consume 1 stack of "Day of the Jackal" to fire off one Duststalker Bolt.
      <br />"Day of the Jackal" lasts for <span class="text-yellow">8</span>s. Max <span class="text-yellow">8</span> stacks. It will be canceled once Pactsworn Pathclearer ends.
      <br />A maximum of <span class="text-yellow">1</span> Duststalker Bolt can be unleashed this way every 0.4s.
